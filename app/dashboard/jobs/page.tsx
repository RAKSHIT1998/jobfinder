  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <button onClick={() => email && load(email)} disabled={loading} className="btn-glass px-4 py-2 rounded-xl text-sm font-semibold text-white/60 disabled:opacity-50 inline-flex items-center gap-2">
            ...
            <RevealItem key={job.id}>
              <TiltCard className="glass glass-hover rounded-2xl p-5 transition-all" max={5}>
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-2 mt-3">
                      <span className="inline-flex items-center gap-1 text-sm text-white/50"><MapPin className="w-3.5 h-3.5" />{job.location}</span>
                ...
                <div className="flex gap-3 mt-4 pt-4 border-t border-white/5">
                  <a href={job.url} target="_blank" rel="noopener noreferrer" className="flex-1 btn-glass py-2.5 rounded-xl text-sm font-semibold text-white/60 hover:text-white text-center inline-flex items-center justify-center gap-1.5">
